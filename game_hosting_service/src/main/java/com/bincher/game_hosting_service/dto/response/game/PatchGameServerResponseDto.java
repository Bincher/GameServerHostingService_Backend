...
public class PatchGameServerResponseDto extends ResponseDto{
    
    private PatchGameServerResponseDto(){
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
    }
    
    public static ResponseEntity<PatchGameServerResponseDto> success(){
        PatchGameServerResponseDto result = new PatchGameServerResponseDto();
